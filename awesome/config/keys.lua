...
--+-+-+-+-+-+-+-+-+-+-+--
  ...
  awful.key({ modkey }, "r", function()    _G.run.open()  end,
...
--+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+--
  ...
  awful.key({ modkey,           }, "d", function () awful.spawn(apps.run) end,
              {description = "run prompt", group = "Programs"}),

  awful.key({ modkey,           }, "F1", function () awful.spawn(apps.files) end,
              {description = "file browser", group = "Programs"}),

  awful.key({ modkey,           }, "F2", function () awful.spawn(apps.browser) end,
              {description = "browser", group = "Programs"}),

  awful.key({ modkey,           }, "F3", function () awful.spawn("codium") end,
              {description = "text edit", group = "Programs"}),

  awful.key({ modkey,           }, "F4", function () awful.spawn.with_shell(apps.inkscape) end,
              {description = "inkscape", group = "Programs"}),

  awful.key({ modkey,           }, "F5", function () awful.spawn.with_shell(apps.gimp) end,
              {description = "gimp", group = "Programs"}),

  awful.key({ modkey,           }, "F9", function () awful.spawn(apps.custom) end,
              {description = "custom GTK/icon/font...", group = "Programs"}),

  awful.key({ modkey,           }, "F12", function () awful.spawn(apps.flameshot) end,
              {description = "flameshot", group = "Programs"}),

  awful.key({  }, "Print", function () awful.spawn.with_shell(apps.fullShot) end,
              {description = "flameshot", group = "Programs"}),
              
 awful.key({modkey,          }, "Print", function () awful.spawn.with_shell(apps.windowShot) end,
              {description = "flameshot", group = "Programs"}),
