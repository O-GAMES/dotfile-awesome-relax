...
-- Fonts
theme.iconfont = 'Iosevka Nerd Font '
theme.uifont = 'Iosevka Bold'
--theme.uifont = 'Digital-7 '
theme.font = theme.iconfont .. " 12"

-- Colors --
theme.transparent = "#00000000"
theme.background = "#8fbcbb"
theme.blue = '#8BB5B5'
theme.green = '#7EC7A2'
theme.pink = '#D46489'
theme.red = '#E06C75'
...
theme.bluealt = '#0F1013'
theme.bluealt_transparent = '#0f1013e5'
theme.grey = '#545862'
theme.orange = '#CAAA6A'
...
-- titlebar icons
theme.titlebar_close_button_normal = icondir .. "titlebar/closenormal.svg"
theme.titlebar_close_button_focus  = icondir .. "titlebar/closefocus.svg"
theme.titlebar_minimize_button_normal = icondir .. "titlebar/minnormal.svg"
theme.titlebar_minimize_button_focus  = icondir .. "titlebar/minfocus.svg"
theme.titlebar_maximized_button_normal_inactive = icondir .. "titlebar/maxnormal.svg"
theme.titlebar_maximized_button_focus_inactive  = icondir .. "titlebar/maxfocus.svg"
theme.titlebar_maximized_button_normal_active = icondir .. "titlebar/maxnormal.svg"
theme.titlebar_maximized_button_focus_active  = icondir .. "titlebar/maxfocus.svg"
